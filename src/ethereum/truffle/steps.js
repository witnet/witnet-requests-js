...
const WitnetRequestsBoardInterface = artifacts.require("WitnetRequestsBoardInterface")
...
module.exports = function (deployer, network) {
  ...
  if (network in addresses) {
    ...
    WitnetRequestsBoardInterface.address = addresses[network]["WitnetRequestsBoardInterface"]
  } else {
    deployer.deploy(CBOR)
    deployer.link(CBOR, Witnet)
    deployer.deploy(Witnet)
    deployer.deploy(MockWitnetRequestsBoard).then(function () {
      return WitnetRequestsBoardInterface.address = MockWitnetRequestsBoard.address
    })
  }
}
`;
...
export function mockSolidityArgs (args) {
  ...
  return args.split(",").map(arg => {
    ...
    if (type === "address" && argName === "_wbi") {
      return "WitnetRequestsBoardInterface.address"
